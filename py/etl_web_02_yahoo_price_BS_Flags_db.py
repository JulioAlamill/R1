...
for ticker in LS_TICKERS:
    try:
        ...
        DF_W['MA_10_BS_Flag']=    np.where( DF_W['MA_10'] > DF_W['close_adj_price'],   -1,1  )                                      
        DF_W['MA_10_BS_Flag'] = DF_W['MA_10_BS_Flag'].fillna(method='ffill')                                         
        
        # 20211116 note off seems to be doing gwrong event trend  change the moving  averages still   below the current price 
        ...
        DF_W['Signal9'] = DF_W['MACD'].ewm(span=9, adjust=False).mean()
        ...
        DF_W['MACD_BS_Flag']=    np.where( DF_W['Signal9'] > DF_W['MACD'],   -1,1  )                                      
        ...
        DF_W['SMI_BS_Flag']=    np.where( DF_W['Signal_line'] > DF_W['SMI'],   -1,1  )                                      
