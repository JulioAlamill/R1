...
CREATE OR REPLACE PROCEDURE etl03_quote_h_update ()
LANGUAGE SQL
as $$
...
--DF_QUOTE_H
DELETE FROM DF_QUOTE_H WHERE LOAD_DATE IN (
SeLECT LOAD_DATE
FROM DF_QUOTE_TABLE); --delet if already load data in the same day 

--insert new data 
 
INSERT INTO DF_QUOTE_H
